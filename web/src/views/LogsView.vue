...
// applyTimeRange 确定时间范围筛选并刷新；clearTimeRange 清空时间范围并刷新（v019 #1）。
// applyTimeRange applies the chosen time range and reloads; clearTimeRange clears it and reloads (v019 #1).
function applyTimeRange() { timeRangeOpen.value = false; page.value = 1; loadLogs() }
function clearTimeRange() { filters.from = ''; filters.to = ''; timeRangeOpen.value = false; page.value = 1; loadLogs() }
